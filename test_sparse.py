...
import time
from model.GRNet_sparse import knn_multiscale
...
def parse_args():
  ...
  parser.add_argument("--ckpts", default='./ckpts_pretrain/sparse/r01/last_epoch.pth', help='Path to pretrained model')
  parser.add_argument("--output_dir", type=str, default='./output/sparse/', help="Output dir")
  parser.add_argument("--gpcc_outdir", type=str, default='./gpcc_out/')
  parser.add_argument("--rate_dir", type=str, default='r01/', help="G-PCC(octree) rate point.")
  parser.add_argument("--GT_dir",default='/media/ivc-18/disk/testdata/12bit_sparse/',help='Ground truth point cloud dir')
